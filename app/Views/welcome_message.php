...
<head>
	<meta charset="UTF-8">
	<title>Selamat Datang Di SISCAPASKA!</title>
	<meta name="description" content="Sistem Informasi Seleksi Calon Paskibraka">
...
<header>
	...
	<div class="menu">
		<ul>
			<li class="logo"><a href="<?=site_url()?>" target="_blank"><img height="44" title="CodeIgniter Logo"
																					alt="Visit CodeIgniter.com official website!"
																					src="logo_siscapaska.png"></a>
			</li>
			<li class="menu-toggle">
				<button onclick="toggleMenu();">&#9776;</button>
			</li>
			<li class="menu-item hidden"><a href="#">Home</a></li>
			<li class="menu-item hidden"><a href="<?=site_url('about')?>" target="_blank">About</a>
			</li>
